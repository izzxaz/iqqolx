                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="admin.php?action=Style&run=Logo&edit=yes" method="post" enctype="multipart/form-data" role="form">
                                        <div class="form-group">
                                            ...
                                            <input name="logotext" class="form-control" value="<?php echo C('WEB_LOGO_TEXT');?>">
                                            <p class="help-block">文字Logo会在大多数情况下被展示.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>图片Logo(仅在模板支持图片Logo时启用)</label>
                                            <input name="logourl" class="form-control" value="<?php echo C('WEB_LOGO_URL');?>" placeholder="如果没有URL，请在下方上传">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <img src="<?php echo C('WEB_LOGO_URL');?>">
                                </div>
                            </div>
                            <!-- /.row (nested) -->
                        </div>
