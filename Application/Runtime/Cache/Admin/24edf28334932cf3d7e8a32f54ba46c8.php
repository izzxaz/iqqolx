                                ...
                                <div class="col-lg-6">
                                    <form action="admin.php?action=WebSiteManager&run=NoticeSetting&edit=yes" method="post" role="form">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notice" rows="10" class="form-control"><?php echo C('WEB_NOTICE');?></textarea>
                                            <p class="help-block">具体位置视模板需求.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>About</label>
                                            <textarea name="about" rows="10" class="form-control"><?php echo C('WEB_ABOUT');?></textarea>
                                        </div>
