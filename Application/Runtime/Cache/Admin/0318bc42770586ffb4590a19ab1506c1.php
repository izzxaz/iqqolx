                                  ...
                                  return false;
                                    ...
                                    <form action="admin.php?action=Xcloud&run=Setting&edit=app" method="post" onsubmit="return show_confirm()" role="form">
                                        <div class="form-group">
                                            <label>APPID</label>
                                            <input name="appid" class="form-control" value="<?php echo C('APPID');?>">
                                            <p class="help-block">切勿随意更改！！<font color=red>后果自负！</font></p>
                                        </div>
                                        <div class="form-group">
                                            <label>APIKEY</label>
                                            <input name="secret" class="form-control" value="<?php echo C('SECRET');?>" placeholder="">
                                            <p class="help-block">切勿随意更改！！<font color=red>后果自负！</font></p>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="admin.php?action=Xcloud&run=Setting&edit=sql" method="post" onsubmit="return show_confirm()" role="form">
                                        <div class="form-group">
                                            <label>数据库地址</label>
                                            <input name="host" class="form-control" value="<?php echo C('DB_HOST');?>">
                                            <p class="help-block">HTTP_HOST.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>数据库端口</label>
                                            <input name="port" class="form-control" value="<?php echo C('DB_PORT');?>">
                                            <p class="help-block">HTTP_HOST.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>数据库名</label>
                                            <input name="dbname" class="form-control" value="<?php echo C('DB_NAME');?>">
                                            <p class="help-block">DATABASE.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>数据库用户名</label>
                                            <input name="user" class="form-control" value="<?php echo C('DB_USER');?>">
                                            <p class="help-block">USER.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>数据库密码</label>
                                            <input name="pwd" class="form-control" value="<?php echo C('DB_PWD');?>">
                                            <p class="help-block">PWD.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>数据库表前缀</label>
                                            <input name="prefix" class="form-control" value="<?php echo C('DB_PREFIX');?>">
