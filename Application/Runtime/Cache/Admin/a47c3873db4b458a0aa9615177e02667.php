    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">iQQOLX Admin Panel</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin.php?action=User&run=Manage"><i class="fa fa-table fa-fw"></i> 用户管理</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">模板风格</a>
                                </li>
                                <li>
                                    <a href="buttons.html">Logo</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank.html">风格中心</a>
                                </li>
                                <li>
                                    <a href="login.html">插件中心</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $rows = M('user')->where($condition)->select(); foreach ($rows as $row) { echo '<tr class="odd gradeX">
                                            <td>'.$row['cid'].'</td>
                                            <td>'.$row['username'].'</td>
                                            <td>'.$row['nickname'].'</td>
